    ...
    if (isProductHasVarian) {
      ...
      if (isHasSubVarian) {
        productInput = {
          ...
          tiktokUrl: createProductDto.tiktokUrl,
          shopeeUrl: createProductDto.shopeeUrl,
          tokopediaUrl: createProductDto.tokopediaUrl,
    ...
    if (isProductHasVarian) {
      ...
      if (isHasSubVarian) {
        productInput = {
          ...
          tiktokUrl: updateProductDto.tiktokUrl,
          shopeeUrl: updateProductDto.shopeeUrl,
          tokopediaUrl: updateProductDto.tokopediaUrl,
          hasVarian: isProductHasVarian ? true : false,
          images: {
